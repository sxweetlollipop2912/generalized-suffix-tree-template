...
private:
     ...
     */
    Node<T_Key> *const root = new Node<T_Key>;
    /**
     ...
     */
    std::pair<Node<T_Key> *, KeyInternal<T_Key>> canonize(Node<T_Key> *node, KeyInternal<T_Key> input) {
        if (!input.empty()) {
